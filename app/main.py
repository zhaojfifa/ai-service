    ...
    try:
        ...
        return GeneratePosterV2Response(
            ...
            debug_artifacts=Poster2DebugArtifacts(
                ...
                slot_structure_layer_url=manifest.debug_artifacts.slot_structure_layer_url,
                content_layer_url=manifest.debug_artifacts.content_layer_url,
                text_layer_url=manifest.debug_artifacts.text_layer_url,
                structure_overlay_url=manifest.debug_artifacts.structure_overlay_url,
                slot_metadata_url=manifest.debug_artifacts.slot_metadata_url,
            ),
