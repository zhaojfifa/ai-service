...
def preview_workbench_email_v2(
    ...
    return EmailAssemblyPreviewResponse(
        ...
        container_visual_variant=str(assembly.get("container_visual_variant") or "ttt_product_sheet_container"),
        banner_source=str(assembly.get("banner_source") or "default_wordmark"),
        banner_replaceable=bool(assembly.get("banner_replaceable", True)),
        banner_variant=str(assembly.get("banner_variant") or "text_wordmark_fallback"),
        banner_composite_used=bool(assembly.get("banner_composite_used")),
        banner_logo_url=assembly.get("banner_logo_url"),
        banner_logo_contrast_mode=str(assembly.get("banner_logo_contrast_mode") or "on_dark"),
        banner_background_mode=str(assembly.get("banner_background_mode") or "dark_plate"),
        banner_filet_used=bool(assembly.get("banner_filet_used", True)),
