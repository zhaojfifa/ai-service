...
def _resolve_family_b_slot_contracts(metadata: TemplateMetadata) -> ResolvedSlotContracts:
    slots = {
        ...
        "agent_name_slot": SlotContractDefinition(
            slot_id="agent_name_slot",
            region_id="logo_banner_region",
            source_binding="agent_name",
            required=False,
            count_min=0,
            count_max=1,
            collapse_rule="collapse when agent_name is empty or suppressed by header mode",
            failure_semantics="agent text may collapse without failing logo_banner_region",
        ),
        "sku_text_slot": SlotContractDefinition(
            slot_id="sku_text_slot",
            region_id="top_copy_region",
            source_binding="sku_text",
            required=False,
            count_min=0,
            count_max=1,
            collapse_rule="collapse when sku_text is empty",
            failure_semantics="sku text may collapse without failing top_copy_region",
        ),
        "title_slot": SlotContractDefinition(
            slot_id="title_slot",
            region_id="top_copy_region",
