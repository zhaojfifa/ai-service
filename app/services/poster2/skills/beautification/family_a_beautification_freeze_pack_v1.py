...
_FAMILY_A_SHELL_SURFACE_PRESETS: dict[str, dict[str, str]] = {
    ...
    "campaign_frozen_panel": {
        "--shell-surface-header": "linear-gradient(180deg, rgba(255, 255, 255, 0.98), rgba(242, 244, 245, 0.96))",
        "--shell-surface-scenario-safe": "linear-gradient(180deg, rgba(246, 248, 249, 0.90), rgba(233, 236, 238, 0.94))",
        "--shell-surface-scenario-real": "linear-gradient(180deg, rgba(255, 255, 255, 0.14), rgba(255, 255, 255, 0.04))",
        "--shell-surface-product": "linear-gradient(180deg, rgba(255, 255, 255, 0.98), rgba(241, 244, 246, 0.95))",
        "--shell-surface-bottom": "linear-gradient(180deg, rgba(255, 255, 255, 0.92), rgba(241, 244, 246, 0.84))",
        "--shell-surface-title-band": "linear-gradient(180deg, rgba(255, 255, 255, 0.98), rgba(241, 244, 246, 0.92))",
        "--shell-surface-gallery-strip": "rgba(249, 250, 250, 0.84)",
        "--feature-card-surface": "linear-gradient(180deg, rgba(255, 255, 255, 0.98), rgba(242, 245, 247, 0.96))",
        "--header-logo-plaque": "linear-gradient(180deg, rgba(255, 255, 255, 0.96), rgba(243, 246, 247, 0.88))",
        "--header-agent-chip-surface": "linear-gradient(180deg, rgba(247, 249, 250, 0.96), rgba(238, 241, 243, 0.88))",
        ...
        "--product-shell-outline": "inset 0 0 0 1px rgba(198, 58, 45, 0.08)",
        "--product-shell-glow": "0 18px 38px rgba(64, 68, 74, 0.08)",
        "--annotation-card-surface": "linear-gradient(180deg, rgba(255, 255, 255, 0.98), rgba(242, 245, 247, 0.94))",
        "--annotation-card-border": "1px solid rgba(198, 58, 45, 0.14)",
        "--annotation-card-shadow": "0 10px 24px rgba(24, 24, 24, 0.10)",
        "--annotation-card-inset": "inset 0 1px 0 rgba(255, 255, 255, 0.90)",
        "--annotation-leader-opacity": "0.82",
        "--annotation-leader-gradient": "linear-gradient(90deg, rgba(198, 58, 45, 0.18), rgba(198, 58, 45, 0.82) 72%, rgba(198, 58, 45, 0.94))",
        "--annotation-leader-height": "2px",
        "--annotation-marker-ring": "rgba(198, 58, 45, 0.14)",
        "--annotation-marker-core-shadow": "0 4px 12px rgba(198, 58, 45, 0.24)",
        "--annotation-marker-size": "14px",
        "--annotation-marker-size-anchored": "16px",
        "--annotation-label-letter-spacing": "0.005em",
        "--bottom-shell-outline": "inset 0 0 0 1px rgba(198, 58, 45, 0.06)",
        "--bottom-shell-glow": "0 16px 34px rgba(71, 76, 82, 0.10)",
        "--title-band-inset": "inset 0 1px 0 rgba(255, 255, 255, 0.92)",
        "--title-band-outline": "inset 0 0 0 1px rgba(198, 58, 45, 0.08)",
        "--title-band-top-rule": "linear-gradient(90deg, rgba(198, 58, 45, 0.18), rgba(198, 58, 45, 0.00))",
        "--subtitle-support-kicker": "rgba(198, 58, 45, 0.72)",
        "--gallery-shell-inset": "inset 0 1px 0 rgba(255, 255, 255, 0.88)",
        "--gallery-shell-outline": "inset 0 0 0 1px rgba(198, 58, 45, 0.06)",
        "--gallery-item-surface": "linear-gradient(180deg, rgba(255, 255, 255, 0.92), rgba(243, 246, 247, 0.86))",
        "--gallery-item-border": "1px solid rgba(214, 218, 221, 0.86)",
